			...
			<div class="swiper-container swiper-portpolio-container">
				<div class="swiper-wrapper">
					<div class="swiper-slide">
						<button type="button" class="frame-box">
							<iframe
								id="player"
								src="https://www.youtube.com/embed/Zu82KK-Y_Yc?si=ETs5yr3fydJZeHFb"
						...
						<p class="option-title text-scale active">STANDARD</p>
						<p class="option-sub">
							라이브클립 (원테이크) / 100,000won <br />(로고 삽입 / 4K / 색 보정 / 촬영시간(분) :
							60분 ~ / 러닝타임(초) : 240초 / 작업일 : ~ 5일 / 수정 횟수 : 1회)
						</p>
						<p class="option-sub">(옵션 : 짐벌 / 조명 / B cam / 피부 보정)</p>
						<p class="option-price">750,000won</p>
					</div>
					<div class="swiper-slide">
						<button type="button" class="frame-box">
							<iframe
								src="https://www.youtube.com/embed/WtirSK5ZqMU?si=tluN1ec87yRBVwKz"
								title="YouTube video player"
								frameborder="0"
								allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share"
								allowfullscreen
					...
					<div class="swiper-slide">
						<button type="button" class="frame-box">
							<iframe
								src="https://www.youtube.com/embed/J4ZT_KwqArY?si=vpM6ApOOnYLczpOq"
								title="YouTube video player"
								frameborder="0"
								allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share"
								allowfullscreen
			...
			<div class="category-box">
				...
				<div class="work-detail-area">
					<div class="flex-box">
						...
						<div class="context-area">
							...
							<p>
								...
								<span class="options"> 수정 횟수 : 1 회 </span>
							</p>
							<p>
								&lt; OPTION &gt;
								<br />
								<span class="options">짐벌 </span>
								<span class="options">조명 </span>
								<span class="options">B cam </span>
								<span class="options">피부 보정</span>
							</p>
							<p>750,000won</p>
						</div>
					</div>
					...
					<div class="flex-box">
						...
						<div class="context-area">
							<p>
								라이브클립 (원테이크)<br />(로고 삽입 / 4K / 색 보정 / 촬영시간(분) : 60분 ~ /
								러닝타임(초) : 240초 / 작업일 : ~ 5일 / 수정 횟수 : 1회)
							</p>
							<p>(옵션 : 짐벌 / 조명 / B cam / 피부 보정)</p>
							<p>750,000won</p>
						</div>
					</div>
				</div>
...
.home-container {
	...
	.swiper-button-prev {
		right: 0;
		background: linear-gradient(to right, rgba(229, 229, 229, 0) 0%, rgba(0, 0, 0, 1) 100%);
